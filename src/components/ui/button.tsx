  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-lg hover:bg-primary-glow hover:shadow-xl hover:scale-105 transition-bounce glow-effect",
        eco: "bg-eco-green text-white shadow-lg hover:bg-eco-green-light hover:shadow-xl hover:scale-105 transition-bounce",
        ecoOutline: "border-2 border-eco-green text-eco-green bg-transparent hover:bg-eco-green hover:text-white transition-smooth",
      },
      size: {
